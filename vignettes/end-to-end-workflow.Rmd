...
## Step 3: Assess complxity and noises
See `vignette("03-ctss-processing.Rmd")` and `vignette("06-noise-estimation")` for full details.
...
DLs <- do.call(c, DLs)
# Unlist to Granges if needed
DLs <- unlist(as(DLs, "GRangesList"))
```
...
The full setup for reticulate python environment, See `vignette("07-prediction")`
...
regions_result <- PRIMEmodel::predict(
    ctss,
