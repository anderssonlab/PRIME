...
files ready for downstream analysis with CAGEfightR and PRIME.
...
See `vignette("ctss-processing")` for the next step.

## See also

- `vignette("getting-started")` — installation and overview
- `vignette("ctss-processing")` — loading BigWig files into PRIME
