---
title: "Getting Started with the PRIME Toolkit"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Getting Started with the PRIME Toolkit}
...
The tools form a linear pipeline, and [CAGEfightR](https://github.com/MalteThodberg/CAGEfightR) provides core CTSS data
...
See the detailed installation guide: `vignette("installation")` or
[articles/installation.html](../articles/installation.html).
...
packages. See the detailed installation guide: `vignette("primemodel-installation")` or
[articles/primemodel-installation.html](../articles/primemodel-installation.html).
...
- `vignette("preprocessing")` — preprocessing CAGE data with PRIMEprep
- `vignette("ctss-processing")` — CTSS quantification and QC with PRIME
