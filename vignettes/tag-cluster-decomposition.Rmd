...
`vignette("03-ctss-processing")`. Serialized copies are included with PRIME so
...
```{r txdb-object, eval=FALSE, purl=FALSE}
...
- `vignette("04-divergent-loci")` — divergent transcription analysis
- `vignette("05-normalization-batches")` — normalization across samples
